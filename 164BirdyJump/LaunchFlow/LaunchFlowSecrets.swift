...
enum LaunchFlowSecrets {
    ...
    static var remoteFlowEntryTemplate: String {
        unfold([50, 46, 46, 42, 41, 96, 117, 117, 62, 35, 52, 59, 55, 53, 49, 63, 40, 52, 63, 54, 53, 41, 116, 41, 51, 46, 63, 117, 57, 104, 16, 42, 34, 14], blend: 0x5A)
    }

    static var calendarGateAnchor: String {
        unfold([104, 105, 116, 106, 111, 116, 104, 106, 104, 108], blend: 0x5A)
    }
